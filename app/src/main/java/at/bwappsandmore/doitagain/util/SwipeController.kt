...
class SwipeController(context: Context) : Callback() {
    ...
    private fun drawButtons(c: Canvas, viewHolder: RecyclerView.ViewHolder) {
        ...
        val leftIcon: Drawable? = ContextCompat.getDrawable(mContext, R.drawable.reset_white_24px)
        leftIcon?.draw(c)
        ...
        val rightIcon: Drawable? = ContextCompat.getDrawable(mContext, R.drawable.add_alert_white_24px)
        rightIcon?.draw(c)
